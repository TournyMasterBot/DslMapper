...
import { MapDocV1, Room } from '../types'
...
export default function RendererPage() {
  ...
  const [doc, setDoc] = React.useState<MapDocV1>(() => {
    return loadFromLocal() ?? { meta:{ directions:[], catalog:{ worlds:{}, continents:{}, areas:{} } }, rooms:{} }
  })
  ...
  return (
    <div className="renderer-page">
      <OctRenderer
        ...
        level={level}
        focusVnum={focusVnum}
        // you can pass center overrides from ?cx=&cy= if you want:
